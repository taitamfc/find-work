                                        ...
                                        <ul class="contacts">
                                            <li>
                                                <a href="#">
                                                    <div class="d-flex bd-highlight">
                                                        <div class="img_cont">
                                                            <img src="images/resource/candidate-1.png"
                                            ...
                                            <li>
                                                <a href="#">
                                                    <div class="d-flex bd-highlight">
                                                        <div class="img_cont">
                                                            <img src="images/resource/candidate-2.png"
                                                                class="rounded-circle user_img" alt="">
                                                        </div>
                                                        <div class="user_info">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <div class="d-flex bd-highlight">
                                                        <div class="img_cont">
                                                            <img src="images/resource/candidate-3.png"
                                                                class="rounded-circle user_img" alt="">
                                                        </div>
                                                        <div class="user_info">
                                                        ...
                                                        <span class="info">35 mins <span
                                                                class="count bg-success">2</span></span>
                                                    </div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <div class="d-flex bd-highlight">
                                                        <div class="img_cont">
                                                            <img src="images/resource/candidate-4.png"
                                                                class="rounded-circle user_img" alt="">
                                                        </div>
                                                        <div class="user_info">
                                            ...
                                            <li class="active">
                                                <a href="#">
                                                    <div class="d-flex bd-highlight">
                                                        <div class="img_cont">
                                                            <img src="images/resource/candidate-5.png"
                                                                class="rounded-circle user_img" alt="">
                                                        </div>
                                                        <div class="user_info">
                                                        ...
                                                        <span class="info">35 mins <span
                                                                class="count bg-warning">2</span></span>
                                                    </div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <div class="d-flex bd-highlight">
                                                        <div class="img_cont">
                                                            <img src="images/resource/candidate-6.png"
                                                                class="rounded-circle user_img" alt="">
                                                        </div>
                                                        <div class="user_info">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <div class="d-flex bd-highlight">
                                                        <div class="img_cont">
                                                            <img src="images/resource/candidate-7.png"
                                                                class="rounded-circle user_img" alt="">
                                                        </div>
                                                        <div class="user_info">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <div class="d-flex bd-highlight">
                                                        <div class="img_cont">
                                                            <img src="images/resource/candidate-8.png"
                                                                class="rounded-circle user_img" alt="">
                                                        </div>
                                                        <div class="user_info">
                            ...
                            <div class=" col-xl-8 col-lg-7 col-md-12 col-sm-12 chat">
                                <div class="card message-card">
                                    <div class="card-header msg_head">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="images/resource/candidate-8.png" alt=""
                                    ...
                                    <div class="card-body msg_card_body">
                                        <div class="d-flex justify-content-start mb-2">
                                            <div class="img_cont_msg">
                                                ...
                                                <div class="name">Albert Flores <span class="msg_time">35 mins</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex justify-content-end mb-2 reply">
                                            <div class="img_cont_msg">
                                                <img src="images/resource/candidate-6.png" alt=""
                                                    class="rounded-circle user_img_msg">
                                        ...
                                        <div class="d-flex justify-content-start">
                                            <div class="img_cont_msg">
                                                <img src="images/resource/candidate-3.png" alt=""
                                                    class="rounded-circle user_img_msg">
                                                <div class="name">Cameron Williamson <span class="msg_time">35
                                                        mins</span></div>
                                            </div>
                                            <div class="msg_cotainer">
                                                Ok, Understood!
                                    ...
                                    <div class="card-footer">
                                        <div class="form-group mb-0">
                                            ...
                                            <button type="button" class="theme-btn btn-style-one submit-btn">Send
                                                Message</button>
                                        </div>
                                    </div>
                                </div>
