                ...
                <div class="ls-widget">
                    <div class="tabs-box">
                        ...
                        <div class="widget-content">
                            ...
                            <form class="default-form" action="{{route('employee.job.update',$job->id)}}" method="post">
                                @if (session('error'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-12 col-md-12">
                                        ...
                                        <input type="text" value="{{$job->name}}" name="name" placeholder="">
                                        @if ($errors->any())
                                    ...
                                    <div class="form-group col-lg-6 col-md-12">
                                        ...
                                        <input type="text" value="{{$job->career}}" name="career" placeholder="">
                                        @if ($errors->any())
                                    ...
                                    <div class="form-group col-lg-6 col-md-12">
                                        ...
                                        <input type="text" value="{{$job->Work_address}}" name="Work_address" placeholder="">
                                        @if ($errors->any())
                                    ...
                                    <div class="form-group col-lg-6 col-md-12">
                                        ...
                                        <textarea name="Job_description">{{$job->Job_description}}</textarea>
                                        @if ($errors->any())
                                    ...
                                    <div class="form-group col-lg-6 col-md-12">
                                        ...
                                        <textarea name="Job_requirements">{{$job->Job_requirements}}</textarea>
                                        @if ($errors->any())
                                    ...
                                    <div class="form-group col-lg-6 col-md-12">
                                        <label>Lương</label>
                                        <input value="{{$job->wage}}" type="text" name="wage" placeholder="">
                                        @if ($errors->any())
                                    ...
                                    <div class="form-group col-lg-12 col-md-12 text-right">
                                        <button class="theme-btn btn-style-one">Cập Nhật Công Việc</button>
                                    </div>
                                </div>
                            </form>
                        </div>
