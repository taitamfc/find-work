<div class="card">
    <div class="card-body">
        <div class="d-flex align-items-center justify-content-between">
            <a href="{{ route('adminpost.index',['type'=>request()->type]) }}" class="btn btn-danger px-4">{{ __('sys.back') }}</a>
...
<div class="card">
    <div class="card-body">
        <div class="mb-4">
            <label class="mb-3">{{ __('adminpost::form.image') }}</label>
        ...
        <div class="mb-4">
            <label class="mb-3">{{ __('adminpost::form.status') }}</label>
