                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-check"><label class="form-check-label">
                                                            <input class="form-check-input" data-val="true"
                                                                data-val-required="The Đang làm ở đây? field is required."
                                                                id="chk-0" name="IsCurrent" type="checkbox"
                                                                value="true"> <label class="form-check-sign"
                                                                for="chk-0">Đang làm ở đây?</label> </label>
                                                    </div><small class="form-text text-muted"> <span
                                                            class="field-validation-valid" data-valmsg-for="IsCurrent"
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group"><label class="required" for="WorkFrom">Thời
                                                            ...
                                                            data-val="true"
                                                            data-val-required="Vui lòng nhập thời gian bắt đầu"
                                                            id="WorkFrom" name="WorkFrom" type="date"
                                                            value="2022-12-22"> <small class="form-text text-muted">
                                                            <span class="field-validation-valid"
                                                                data-valmsg-for="WorkFrom"
                                                                data-valmsg-replace="true"></span> </small>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group"><label for="WorkTo">Thời gian
                                                            kết thúc</label> <input class="form-control" id="WorkTo"
                                                            name="WorkTo" type="date"> <small
