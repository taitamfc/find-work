<div class="row">
    <div class="col-12 col-md-6">
        <div class="row">
            <div class="form-group input-numerical-update col-lg-6 col-md-12 ">
                <label>Thứ tự</label>
...
<div class="text-right" style="display: flex; align-items: center;">
    <button class="d-flex btn btn-primary ms-auto experience-update" type="button" style="margin-top: 20px;">
